...
class DeepJobSearchConfig(BaseModel):
    ...
    low_novelty_threshold: float = Field(default=0.25, ge=0, le=1)
    low_qualified_yield_threshold: float = Field(default=0.15, ge=0, le=1)
    search_combination_safety_limit: int = Field(default=24, ge=1, le=200)
