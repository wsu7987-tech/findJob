...
CREATE TABLE IF NOT EXISTS fj_chat_send_actions (
  ...
  resume_invite_message_id TEXT NOT NULL DEFAULT '',
    ...
    def _ensure_codex_integration_schema(self, connection: sqlite3.Connection) -> None:
        ...
        migrations = {
            ...
            "fj_chat_send_actions": {
                ...
                "resume_invite_message_id": "ALTER TABLE fj_chat_send_actions ADD COLUMN resume_invite_message_id TEXT NOT NULL DEFAULT ''",
